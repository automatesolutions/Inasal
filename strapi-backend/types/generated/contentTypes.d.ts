...
export interface ApiAttractionAttraction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.Component<'shared.location', true>;
    name: Schema.Attribute.String;
    personlaity_match: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInteractionLogInteractionLog
  extends Struct.CollectionTypeSchema {
  collectionName: 'interaction_logs';
  info: {
    displayName: 'Interaction Log';
    pluralName: 'interaction-logs';
    singularName: 'interaction-log';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    interaction_type: Schema.Attribute.Enumeration<
      [
        '     chat',
        '     search',
        '     view_destination',
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::interaction-log.interaction-log'
    > &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<'oneToOne', 'api::attraction.attraction'>;
  };
}
...
export interface ApiRecommendationRecommendation
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entertainment: Schema.Attribute.JSON;
    expirest_at: Schema.Attribute.DateTime;
    hotels: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserProfileUserProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    personality: Schema.Attribute.JSON;
    preferences: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    travel_history: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
